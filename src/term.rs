...
// sha3: d955ee7e165238f0879b8a336c43e30c25434f155776ae35d78a999ce65057b9
use std::str::FromStr;
...
{
    Box::new(Term::App(Box::new(*t1), Box::new(*t2)))
}
...
{
    Box::new(Term::Abs(s.as_bytes()[0], Box::new(*t1)))
}
